...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Hero Section
    'hero.title': 'The legacy industry software modernization partner',
    'hero.subtitle': 'Bytesavy Technologies accelerates operational efficiency and growth with custom software solutions built for your industry.',
    'hero.trusted': 'Trusted by leading organizations',

    // Services
    'services.title': 'The seamless blend of technology, data and industry expertise',
    'services.custom.title': 'Custom Software Development',
    'services.custom.description': 'Purpose-built applications that modernize your operations, reduce manual work and drive measurable results.',
    ...
    'cta.subtitle': "Let's discuss how custom software can transform your business.",
  ...
  fr: {
    ...
    // Hero Section
    'hero.title': 'Le partenaire de modernisation des logiciels pour les industries traditionnelles',
    'hero.subtitle': 'Bytesavy Technologies accélère l\'efficacité opérationnelle et la croissance avec des solutions logicielles personnalisées conçues pour votre industrie.',
    'hero.trusted': 'Approuvé par les principales organisations',

    // Services
    'services.title': 'Le mélange harmonieux de technologie, de données et d\'expertise industrielle',
    'services.custom.title': 'Développement de Logiciels Personnalisés',
    'services.custom.description': 'Applications sur mesure qui modernisent vos opérations, réduisent le travail manuel et produisent des résultats mesurables.',
    ...
    'cta.subtitle': 'Discutons de la façon dont les logiciels personnalisés peuvent transformer votre entreprise.',
  ...
  es: {
    ...
    // Hero Section
    'hero.title': 'El socio de modernización de software para industrias tradicionales',
    'hero.subtitle': 'Bytesavy Technologies acelera la eficiencia operativa y el crecimiento con soluciones de software personalizadas diseñadas para su industria.',
    'hero.trusted': 'Con la confianza de las principales organizaciones',

    // Services
    'services.title': 'La combinación perfecta de tecnología, datos y experiencia industrial',
    'services.custom.title': 'Desarrollo de Software Personalizado',
    'services.custom.description': 'Aplicaciones diseñadas específicamente que modernizan sus operaciones, reducen el trabajo manual y generan resultados medibles.',
    ...
    'cta.subtitle': 'Hablemos de cómo el software personalizado puede transformar su negocio.',
